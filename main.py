...
class Ui_LegoSorterEESS(object):
    def setupUi(self, LegoSorterEESS):
        ...
        self.img.setGeometry(QRect(50, 40, 441, 261))
        self.img.setPixmap(QPixmap(u"rick.jpg"))
    ...
    def retranslateUi(self, LegoSorterEESS):
        LegoSorterEESS.setWindowTitle(QCoreApplication.translate(
            "LegoSorterEESS", u"Lego Sorter EESS", None))
        self.pushButton.setText(QCoreApplication.translate(
            "LegoSorterEESS", u"Le Button", None))
        self.PieceNamepre.setText(QCoreApplication.translate(
            "LegoSorterEESS", u"Name:", None))
        self.PieceIDpre.setText(QCoreApplication.translate(
            "LegoSorterEESS", u"ID:", None))
        self.PieceName.setText(QCoreApplication.translate(
            "LegoSorterEESS", u"PieceNameText", None))
        self.PieceID.setText(QCoreApplication.translate(
            "LegoSorterEESS", u"PieceIDText", None))
        self.img.setText("")
    # retranslateUi
